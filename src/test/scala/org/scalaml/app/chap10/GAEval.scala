...
object GAEval extends Eval {
  ...
  private val XOVER = 0.8
  // Probability or ratio for cross-over
  private val MU = 0.4
  // Probability or ratio for mutation
  private val MAX_CYCLES = 1000
  // Maximum number of iterations during the optimization
  private val CUTOFF_SLOPE = -0.001
  // Slope for the linear soft limit
  private val CUTOFF_INTERCEPT = 1.003
  // Intercept value for the linear soft limit
  private val R = 1024
  // Quantization ratio for conversion Int <-> Double
